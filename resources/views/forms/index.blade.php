...
<body class="d-flex flex-column">
    ...
    <div class="container">
        ...
        @if (session('successMessage'))
            <div class="alert alert-success d-flex flex-column w-100 justify-content-center text-center items-center">
                {!! session('successMessage') !!}
                <a class="link-opacity-100" href="{{ url(session('linkPath')) }}">Başvuru aşamalarınızı takip etmek için
                    lütfen bu
                                ...
                                <div class="d-flex flex-column gap-2 pt-5 justify-content-center align-items-center ">
                                    <div class="custom-file-input">
                                        ...
                                        <label id="path_gonullu_onam_form_label" for="onam_path"> Gönüllü Onam
                                            Formu</label>
                                        <input class="form-control" type="file" name="onam_path"
                                            accept="application/pdf" id="onam_path" required>
                                    </div>
                                    <div class="custom-file-input">
