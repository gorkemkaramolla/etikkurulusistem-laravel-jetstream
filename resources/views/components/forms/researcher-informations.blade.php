...
<div class="container pt-1">
    <div class="row g-3">
        <div class="col-md-4">
            ...
            <input readonly type="text" name="name" id="name" class="form-control bg-light"
        ...
        <div class="col-md-4">
            ...
            <input id="lastname" type="text" name="lastname" class="form-control bg-light" readonly
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="student_no" class="form-control " id="studentID"
                value="{{ old('student_no', auth()->user()->username) }}">
        </div>
        <div class="col-md-4">
            <label for="email" class="form-label">Mail Adressi<br><span class="pt-0 small">Email
                    Address</span></label>
            <input readonly type="email" name="email" class="form-control bg-light" id="email"
