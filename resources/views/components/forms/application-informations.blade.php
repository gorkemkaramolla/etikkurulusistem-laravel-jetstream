    ...
    <div class="row g-3">
        ...
        <div class="col-md-4 form-group">
            ...
            <select class="form-control" name="temel_alan_bilgisi" required>
                ...
                <option value="Sosyal Bilimler" {{ old('temel_alan_bilgisi') == 'Sosyal Bilimler' ? 'selected' : '' }}>
                    Sosyal Bilimler</option>
                <option value="Fen/Mühendislik Bilimleri"
                    {{ old('temel_alan_bilgisi') == 'Fen/Mühendislik Bilimleri' ? 'selected' : '' }}>Fen/Mühendislik
                    Bilimleri</option>
                <option value="Sağlık Bilimleri"
                    {{ old('temel_alan_bilgisi') == 'Sağlık Bilimleri' ? 'selected' : '        <' }}>Sağlık Bilimleri
                </option>
            </select>
        </div>
        ...
        <div class="col-md-4 form-group">
            ...
            <select class="form-control" name="application_type" onchange="toggleOtherInput(this, 'otherInput');"
                required>
                <option value="Başvuru Türü" {{ old('application_type') == 'Başvuru Türü' ? 'selected' : '' }}>Başvuru
                    Türü </option>
                <option value="Yeni Başvuru" {{ old('application_type') == 'Yeni Başvuru' ? 'selected' : '' }}>Yeni
                    Başvuru</option>
                <option value="Düzeltme" {{ old('application_type') == 'Düzeltme' ? 'selected' : '' }}>Düzeltme</option>
                <option value="Amaç/Yöntem Değişikliği"
                    {{ old('application_type') == 'Amaç/Yöntem Değişikliği' ? 'selected' : '' }}>Amaç/Yöntem Değişikliği
                </option>
                <option value="Devam Eden Proje" {{ old('application_type') == 'Devam Eden Proje' ? 'selected' : '' }}>
                    Devam Eden Proje</option>
        ...
        <div class="col-md-4 form-group">
            ...
            <select class="form-control" name="work_qualification" onchange="toggleOtherInput(this, 'otherInput');"
                ...
                <option value="Yüksek Lisans Tezi"
                    {{ old('work_qualification') == 'Yüksek Lisans Tezi' ? 'selected' : '' }}>Yüksek Lisans Tezi
                </option>
                <option value="Doktora/Sanatta Yeterlik Tezi"
                    {{ old('work_qualification') == 'Doktora/Sanatta Yeterlik Tezi' ? 'selected' : '' }}>
                    Doktora/Sanatta Yeterlik Tezi</option>
                <option
                    value="BAP destekli proje"{{ old('work_qualification') == 'BAP destekli proje' ? 'selected' : '' }}>
                    BAP destekli proje</option>
                <option value="TÜBİTAK Projesi"{{ old('work_qualification') == 'TÜBİTAK Projesi' ? 'selected' : '' }}>
                    TÜBİTAK Projesi </option>
        ...
        <div class="col-md-4 form-group">
            ...
            <select class="form-control" name="research_type" onchange="toggleOtherInput(this, 'otherInput');" required>
                ...
                <option value="Tarama Çalışması" {{ old('research_type') == 'Tarama Çalışması' ? 'selected' : '' }}>
                    Tarama Çalışması</option>
                <option value="Deneysel Çalışma"{{ old('research_type') == 'Deneysel Çalışma' ? 'selected' : '' }}>
                    Deneysel Çalışma</option>
                <option value="itel Çalışma"{{ old('research_type') == 'itel Çalışma' ? 'selected' : '' }}>Nitel
                    Çalışma</option>
                <option value="Karma Yöntem"{{ old('research_type') == 'Karma Yöntem' ? 'selected' : '' }}>Karma Yöntem
                </option>
        ...
        <div class="col-md-4 form-group">
            ...
            <select class="form-control" name="institution_permission" required>
                <option value="Kurum İzni seçiniz"
                    {{ old('institution_permission') == 'Kurum İzni seçiniz' ? 'selected' : '' }}>Kurum İzni seçiniz
                </option>
                <option value="Kurum İzni Alınmıştır"
                    {{ old('institution_permission') == 'Kurum İzni Alınmıştır' ? 'selected' : '' }}>Kurum İzni
                    Alınmıştır</option>
                <option value="Kurum İzni İçin Başvuru Yapılmıştır"
                    {{ old('institution_permission') == 'Kurum İzni İçin Başvuru Yapılmıştır' ? 'selected' : '' }}>
                    Kurum İzni İçin Başvuru Yapılmıştır</option>
                <option value="Kurum, etik kurul sonrası izin vereceğini belirtmektedir"
                    {{ old('institution_permission') == 'Kurum, etik kurul sonrası izin vereceğini belirtmektedir' ? 'selected' : '' }}>
                    Kurum, etik kurul sonrası izin vereceğini belirtmektedir</option>
                <option value="Kurum iznine gerek yoktur"
                    {{ old('institution_permission') == 'Kurum iznine gerek yoktur' ? 'selected' : '' }}>Kurum iznine
                    gerek yoktur</option>
            </select>
        </div>
