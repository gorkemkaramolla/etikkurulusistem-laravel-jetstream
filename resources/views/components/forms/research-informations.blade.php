...
Why is this research important? What distinguishes this research from others? Mention the contributions of this research to the literature in short and clear sentences. Please indicate if it will make a very special contribution to the world of science or humanity other than literature.">{{ old('research_unique_value') }}</textarea>
    ...
    <label class="p-2 badge rounded-pill bg-primary mb-0 ">Hipotezler / Araştırma Soruları | Hypotheses / Research
        Questions</label>
    <div class="d-flex text-body-secondary pt-1">
...
While writing this part, you need to clearly write which research method you chose, the scientific paradigm on which the research method is based, which technique the method requires, which technique you will use in your study, and why you chose this technique.">{{ old('research_method') }}</textarea>
    </div>
...
Write the population of the research and how you chose the sample from this population. Please write which type of sampling you used.">{{ old('research_universe') }}</textarea>
    </div>
...
Write the source of the scales and forms to be used in the research.">{{ old('research_forms') }}</textarea>
    </div>
...
Detailed information about each measurement tool to be used in the research should be given under separate headings.">{{ old('research_data_collection') }}</textarea>
    </div>
...
How did you delimit the scope and topic of your research and what are the main constraints on applying the research?">{{ old('research_restrictions') }}</textarea>
    </div>
...
Create a research calendar for when and where you will conduct field work (if any).">{{ old('research_place_date') }}</textarea>
    </div>
...
Sources related to the research topic should be given in accordance with the Nişantaşı University Graduate Education Institute Thesis Writing Guide. It should be written as a list of references. You can obtain the guide from lee.nisantasi.edu.tr. ">{{ old('research_literature_review') }}</textarea>
    </div>
</div>
